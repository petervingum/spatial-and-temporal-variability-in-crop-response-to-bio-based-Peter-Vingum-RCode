...
plot3 <- ggarrange(plot_ref, plot_bbf1, plot_bbf2,
  ...
  # Rename the elements in the list
  names(results) <- c( ######and comment out here
    paste0("mod_int_", name_prefix),
    paste0("mod_no_int_", name_prefix),
    paste0("anova_result_", name_prefix),
    paste0("plot_residuals_no_int_", name_prefix),
...
results_ndre_data26_residual_mean_ww$plot_response_ndre_data26_residual_mean_ww <-
  annotate_figure(results_ndre_data26_residual_mean_ww$plot_response_ndre_data26_residual_mean_ww,
                 top = text_grob("ndre over time, Small plot trial - Winter Wheat, residual fertiliser - 2022",
                               face = "bold", size = 14))
